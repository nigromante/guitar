...
class Instrumento
{
  ...
  {    // Getter -- Obtenr informacion del objeto
  ...
  public function SetTipo(InstrumentoFamilia $tipo)
  {
    $this->tipo = $tipo;
    return $this;
  }   //  Setter --- Asigna info al objeto

  public function Descripcion()
  {
    return  ucfirst($this->descripcion);
  }
  public function DescripcionOriginal()
  {
  ...
  {
    return $this->Alias() . ":" . $this->Nombre() . " / " . $this->Tipo() . " ::: "  . $this->Descripcion();
  }
}
